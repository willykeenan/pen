...
KE Pen 0.4.5 makes the first-use path much shorter while keeping the same local,
...
Use `KE-Pen-0.4.5-SHA256SUMS.txt` to verify the exact files.
...
0.4.5 launches the asar-less embedded server through the app's packaged Node
