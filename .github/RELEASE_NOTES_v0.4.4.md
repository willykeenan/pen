...
KE Pen 0.4.4 makes the first-use path much shorter while keeping the same local,
...
Use `KE-Pen-0.4.4-SHA256SUMS.txt` to verify the exact files.
...
builds before the release is published. Version 0.4.4 launches the asar-less
